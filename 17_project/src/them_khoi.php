...
<body>
	...
	<main style="min-height: 100vh; max-width: 100%;">
		<div id="action" style="margin: 20px 0 0 13%;">
			<p class="h3" style="text-transform: capitalize;">Thêm khối xét tuyển</p>
		...
		<form method="POST" enctype="multipart/form-data">
         <div style="margin: 20px 13%;">
            ...
            <div class="form-group">
               ...
               <input class="form-control"  type="text" name="subject_1" id="" value="<?php val('btn','subject_1') ?>">
            </div>

            <div class="form-group">
               <label for="name_quiz"><span style="color: red;">*</span>Nhập tên môn 2</label>
               <input class="form-control"  type="text" name="subject_2" id="" value="<?php val('btn','subject_2') ?>">
            </div>

            <div class="form-group">
               <label for="name_quiz"><span style="color: red;">*</span>Nhập tên môn 3</label>
               <input class="form-control"  type="text" name="subject_3" id="" value="<?php val('btn','subject_3') ?>">
            </div>
            ...
            <?php 
            	if (isset($_POST['btn'])) {
                  ...
                  if ($check == 1) {
                  	...
                  	if (!existsGroupName($name, 0)) {
                  		if (addSubjectGroup($name, $sub1, $sub2, $sub3)) {
	                  		header("location: khoi.php");
	                  	}else{
	                  		echo "<div class='alert alert-danger text-center' role='alert'>Thêm khối xét tuyển thất bại</div>";
	                  	}
                  	}else{
            ...
            <div style="margin: 20px 0 0 0;" class="d-grid">
               <input class="btn btn-primary btn-block" name="btn" type="submit" value="Thêm khối xét tuyển">
            </div>
         </div>
      </form>
	</main>
